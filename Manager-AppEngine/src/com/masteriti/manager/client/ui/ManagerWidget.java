...
import com.masteriti.manager.shared.client.ManagerRequestFactory.MessageRequest;
...
public class ManagerWidget extends Composite {
  ...
  interface ManagerUiBinder extends UiBinder<Widget, ManagerWidget> {
  }

  private static ManagerUiBinder uiBinder = GWT.create(ManagerUiBinder.class);
  ...
  public ManagerWidget() {
    ...
    final ManagerRequestFactory requestFactory = GWT.create(ManagerRequestFactory.class);
